...
*****************************************************************************/
#ifndef WIN32
	JVSERVER_API void JVN_RegClientMsgCallBack(FUNC_RECVCLIENTMSG_CALLBACK FRecvMsgCallBack);
#else
...
*****************************************************************************/
#ifndef WIN32
	JVSERVER_API void JVN_SetWANClientLimit(int nWANMax);
#else
	JVSERVER_API void __stdcall	JVN_SetWANClientLimit(int nWANMax);
#endif
...
*****************************************************************************/
#ifndef WIN32
	JVSERVER_API int JVN_GetNetSpeedNow(int nChannel, int nClientID, int nInterval, int* pSpeed, int* pSendOK, unsigned long *pdwFrameDelay);
#else
	JVSERVER_API int __stdcall JVN_GetNetSpeedNow(int nChannel, int nClientID, int nInterval, int* pSpeed, BOOL* pSendOK, DWORD *pdwFrameDelay);
#endif
...
#ifndef WIN32
	JVSERVER_API int JVN_RegNickName(char chNickName[36]);
#else
	JVSERVER_API int __stdcall JVN_RegNickName(char chNickName[36]);
#endif
...
#ifndef WIN32
	JVSERVER_API int JVN_DeleteNickName(char chNickName[36]);
#else
	JVSERVER_API int __stdcall JVN_DeleteNickName(char chNickName[36]);
#endif
...
#ifndef WIN32
	JVSERVER_API int JVN_GetNickName();
#else
	JVSERVER_API int __stdcall JVN_GetNickName();
#endif
...
*****************************************************************************/
#ifndef WIN32
	JVSERVER_API void JVN_SendJvnInfo(JVSERVER_INFO *jvsvr_info, struct sockaddr_in *svrAddr);
#else
	JVSERVER_API void __stdcall JVN_SendJvnInfo(JVSERVER_INFO *jvsvr_info, SOCKADDR_IN *svrAddr);
#endif
...
*****************************************************************************/
#ifndef WIN32
	JVSERVER_API void JVN_SendChannelInfo(int nMsgLen, char *chChnInfo, int nConnCount);
#else
	JVSERVER_API void __stdcall	JVN_SendChannelInfo(int nMsgLen, char *chChnInfo, int nConnCount);
#endif
...
#ifndef WIN32
	JVSERVER_API int  JVN_GetExamItem(char *pExamItem,int nSize);
#else
		JVSERVER_API int __stdcall	JVN_GetExamItem(char *pExamItem,int nSize);
#endif
...
#ifndef WIN32
	JVSERVER_API int  JVN_ExamItem(int nExamType,char* pUserInfo,FUNC_EXAM_CALLBACK callBackExam);
#else
	JVSERVER_API int __stdcall	JVN_ExamItem(int nExamType,char* pUserInfo,FUNC_EXAM_CALLBACK callBackExam);
#endif
...
*****************************************************************************/
#ifndef WIN32
	JVSERVER_API int JVN_GetPositionID(int nGetType);
#else
	JVSERVER_API int __stdcall JVN_GetPositionID(int nGetType);
#endif
...
*****************************************************************************/
#ifndef WIN32
	JVSERVER_API void JVN_SetNickName(char chNickName[32]);
#else
	JVSERVER_API void __stdcall	JVN_SetNickName(char chNickName[32]);
#endif
