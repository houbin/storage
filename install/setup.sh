...
# clear old files
\rm -f /etc/rc.d/init.d/storage_boot_auto_mount
...
\cp -f storage_boot_auto_mount /etc/rc.d/init.d/
...
chmod +x /etc/rc.d/init.d/storage_boot_auto_mount
chmod +x /lib/${LIBSTORAGE_SO}
chmod +x /lib/${LIBNT88_SO}
chmod +x /usr/bin/${JCVR_EXE}

chkconfig --add storage_boot_auto_mount
